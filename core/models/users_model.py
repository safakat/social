...
class User(AbstractBaseUser):
    ...
    username = models.CharField(verbose_name='username', max_length=250,null=False, blank=False, unique=True)
    email = models.EmailField(verbose_name='email address',max_length=255,unique=True, null=False, blank=False)
    full_name = models.CharField(verbose_name='Full Name', max_length=500, null=True, blank=True)
